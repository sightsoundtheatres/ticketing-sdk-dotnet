...
namespace SightSound.TicketingSDK.Model
{
    ...
    public partial class ApplicationInfo : IEquatable<ApplicationInfo>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets PaymentDetailsSource
        /// </summary>
        [DataMember(Name = "paymentDetailsSource", EmitDefaultValue = false)]
        public CommonField PaymentDetailsSource { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PaymentDetailsSource: ").Append(PaymentDetailsSource).Append("\n");
        ...
        public bool Equals(ApplicationInfo input)
        {
            ...
            return 
                ...
                (
                    this.PaymentDetailsSource == input.PaymentDetailsSource ||
                    (this.PaymentDetailsSource != null &&
                    this.PaymentDetailsSource.Equals(input.PaymentDetailsSource))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaymentDetailsSource != null)
                {
                    hashCode = (hashCode * 59) + this.PaymentDetailsSource.GetHashCode();
                }
